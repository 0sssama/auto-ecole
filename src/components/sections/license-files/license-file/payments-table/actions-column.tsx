...
const ActionsColumn: ActionsColumnComponentType<LicenseFilePayment> = ({ row }) => {
  const t = useTranslations('Dashboard.Files.LicenseFiles.FilePage.LicenseFileLessons.Actions');
      ...
      <DropdownMenuContent align="start" className="w-[160px]">
        <DropdownMenuItem className="cursor-pointer text-sm font-medium text-muted-foreground/90">
          <Link
            ...
            href={`/dash/admin/license-files?licenseFileId=${licenseFilePayment.id}`}
          >
        ...
        <DropdownMenuItem
          ...
          onClick={() => console.log('editing', licenseFilePayment.id)}
        >
