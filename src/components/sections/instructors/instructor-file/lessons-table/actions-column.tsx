...
const ActionsColumn: ActionsColumnComponentType<InstructorLesson> = ({ row }) => {
  const t = useTranslations('Dashboard.Dossier.Tables.InstructorLessons.Actions');
      ...
      <DropdownMenuContent align="start" className="w-[160px]">
        <DropdownMenuItem className="cursor-pointer text-sm font-medium text-muted-foreground/90">
          <Link
            ...
            href={`${DASH_LESSONS_PATH}?lessonId=${instructorLesson.id}`}
          >
