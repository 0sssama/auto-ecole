...
const ActionsColumn: ActionsColumnComponentType<StudentLicenseFile> = ({ row }) => {
  const t = useTranslations('Dashboard.Dossier.Tables.StudentLicenseFiles.Actions');
      ...
      <DropdownMenuContent align="start" className="w-[160px]">
        <DropdownMenuItem className="cursor-pointer text-sm font-medium text-muted-foreground/90">
          <Link
            ...
            href={`${DASH_LICENSE_FILES_PATH}?licenseFileId=${licenseFile.id}`}
          >
