...
import type { DossierInfoProps, InfoDataProps, InfoTypes } from './dossier-info.types';

/**
 * SHITTY CODE ALERT - REFACTOR ASAP
 */

const InfoData = <InfoT extends InfoTypes>({ labelId, value }: InfoDataProps<InfoT>) => {
...
const DossierInfo = <InfoT extends InfoTypes>({
  labelId,
  value,
  setValue,
  editing,
