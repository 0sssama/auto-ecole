...
import { useDeleteExam } from '@/base/hooks/exams/delete/use-delete-exam';

import type { ModalComponentType } from '../../modal.types';

import type { ModalContext } from './delete-confirm.types';

const DeleteExamConfirm: ModalComponentType<ModalContext> = ({ isOpen, close, context: { examId } }) => {
