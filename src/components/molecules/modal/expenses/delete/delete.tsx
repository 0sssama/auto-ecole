...
import { useDeleteExpense } from '@/base/hooks/expenses/delete/use-delete-expense';

import type { ModalComponentType } from '../../modal.types';

import type { ModalContext } from './delete.types';

const DeleteExpenseModal: ModalComponentType<ModalContext> = ({ isOpen, close, context: { expenseId } }) => {
